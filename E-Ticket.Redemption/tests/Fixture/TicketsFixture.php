...
class TicketsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'registered_buyer' => ['type' => 'string', 'length' => 50, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'scanned_date_time' => '2015-08-04 02:16:43',
            'event_id' => 1,
            'event_start' => '2015-08-04 02:16:43',
            'event_end' => '2015-08-04 02:16:43'
        ],
    ];
}

...
<?= $this->fetch('html') ?>
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a href="<?= $this->Url->build('/', true); ?>dashboard">
                    <img src="<?= $this->Url->build('/', true).'img/Stellar Logo White.png'?>" width="140" style="padding-top:5px; padding-left:15px;">
                </a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar " role="navigation">
                <div class="sidebar-nav navbar-collapse " style="margin-top:15px">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a style="color:white" href="<?= $this->Url->build('/', true); ?>settings"><i class="fa fa-cog fa-fw"></i> Setting</a>
                        </li>
                        <?php } ?>
    ...
    if($isLoggogedIn)
		...
		echo '<center class="img-overlay"><img src="'.$this->Url->build('/', true).'img/indoopen16.png"></center>';
